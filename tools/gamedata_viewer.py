...
def main(argv: list[str] | None = None) -> int:
    parser=argparse.ArgumentParser(prog="gamedata-viewer"); parser.add_argument("path",nargs="?",type=Path,default=Path("OrrunGameData.xml")); parser.add_argument("--validate",action="store_true")
