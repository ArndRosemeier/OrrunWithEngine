...
pub struct CombatMesh {
    ...
    pub anim_walk: Option<&'static str>,   // Some("Walk")
    pub anim_run: Option<&'static str>,    // Some("Run")
...
pub fn mesh_spec(mob_id: &str) -> Option<CombatMesh> {
    Some(match mob_id {
        ...
        "deer" => CombatMesh {
            id: "deer",
            source: "fauna/deer/deer.gltf",
            anim_idle: "Idle",
            anim_walk: Some("Walk"),
            anim_run: Some("Gallop"),
            anim_melee: "Attack_Headbutt",
            anim_death: Some("Death"),
            anim_weapon: None,
            weapon_node: None,
        },
        "skeleton_warrior" => CombatMesh {
            ...
            anim_idle: "Idle",
            anim_walk: Some("Walking_A"),
            anim_run: Some("Running_A"),
